...
public class LinkedinBatchApplication {
	...
	public Step thankCustomerStep() {
		return this.stepBuilderFactory.get("thankCustomerStep")
				.tasklet((contribution, chunkContext) -> {
	...
	public Step refundStep() {
		return this.stepBuilderFactory.get("refundStep")
				.tasklet((contribution, chunkContext) -> {
	...
	public static void main(String[] args) {
		SpringApplication.run(LinkedinBatchApplication.class, "item=Apple Laptop", "run.date(date)=2021/12/12", "type=roses");
	}
